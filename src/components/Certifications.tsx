...
const CertificationCard = ({ 
  ...
  <button
    ...
    className={`bg-gray-700/40 border border-gray-600 rounded-lg p-6 transition-all duration-300 hover:border-gray-500 hover:bg-gray-700/60 text-left group cursor-pointer transform ${
  ...
  >
    <div className="flex items-start gap-4 mb-4">
      <div className="p-3 bg-gray-600/40 rounded-lg border border-gray-600 flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
        {cert.icon}
      </div>
        ...
        >
          ...
          <div className="sticky top-0 bg-gray-800 border-b border-gray-600 p-6 flex items-start justify-between gap-4">
            <div className="flex-1">
              <h2 id="modal-title" className="text-white text-lg font-medium leading-tight">{cert.title}</h2>
            ...
            <div>
              ...
              <ul className="flex flex-wrap gap-2" role="list">
                {cert.skills.map((skill) => (
                  <li key={skill}>
                    <span className="px-3 py-1.5 text-xs bg-gray-700/50 text-gray-300 rounded border border-gray-600 inline-block">
                      {skill}
                    </span>
                  </li>
                ))}
    ...
    <section id="certifications" className="py-20 px-2 sm:px-6 bg-gray-800">
      <div className="container mx-auto">
        <div className="mb-12">
          ...
          <p className={`text-center text-gray-400 mb-8 max-w-2xl mx-auto text-lg font-light transition-all duration-1000 delay-200 ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}>
          ...
          {/* Filter Buttons */}
          <div className={`flex flex-wrap justify-center gap-3 mb-8 transition-all duration-1000 delay-300 ${
        ...
        {filteredCerts.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 w-full mx-auto px-0">
